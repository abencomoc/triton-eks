...
locals {
  ...
  custom_nodepool_yamls = [
    "nodepool-basic.yaml",
    "nodepool-cpu-arm-graviton.yaml",
    "nodepool-cpu-x86-intel.yaml",
    "nodepool-cpu-x86-amd.yaml",
    "nodepool-gpu-g-nvidia.yaml",
    "nodepool-gpu-p-nvidia.yaml",
    "nodepool-trainium.yaml",
    "nodepool-inferentia.yaml"
  ]
}
